...
public class DelegatingImageClient : IImageClient
{
    ...
    /// <inheritdoc />
    public virtual IAsyncEnumerable<ImageResponseUpdate> GenerateImagesStreamingAsync(
        ImageRequest request, ImageOptions? options = null, CancellationToken cancellationToken = default)
    {
        return InnerClient.GenerateImagesStreamingAsync(request, options, cancellationToken);
    }
