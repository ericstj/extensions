...
public class ImageClientMetadata
{
    ...
    /// The name of the image provider, if applicable. Where possible, this should map to the
    /// appropriate name defined in the OpenTelemetry Semantic Conventions for Generative AI systems.
    /// </param>
    /// <param name="providerUri">The URL for accessing the image provider, if applicable.</param>
    /// <param name="defaultModelId">The ID of the image model used by default, if applicable.</param>
    ...
    /// <summary>Gets the name of the image provider.</summary>
    /// <remarks>
    ...
    /// <summary>Gets the URL for accessing the image provider.</summary>
    public Uri? ProviderUri { get; }

    /// <summary>Gets the ID of the default model used by this image client.</summary>
    /// <remarks>
