...
{
    /// <summary>The content items in the generated image response.</summary>
    ...
    /// <summary>Gets or sets the raw representation of the image response from an underlying implementation.</summary>
    /// <remarks>
    /// If an <see cref="ImageResponse"/> is created to represent some underlying object from another object
