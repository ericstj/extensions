...
{
    /// <summary>
    /// Adds a callback that configures an <see cref="ImageOptions"/> to be passed to the next client in the pipeline.
    /// </summary>
    ...
    /// <see cref="ImageOptions"/> if the caller didn't supply an <see cref="ImageOptions"/> instance, or a clone (via <see cref="ImageOptions.Clone"/>)
